...
type PayloadScraper struct{}

func NewPayloadScraper() *PayloadScraper {
	return &PayloadScraper{}
}

func (s *PayloadScraper) GetArraysPayloadsFromWebsite() ([][]string, error) {
	var payloads [][]string
...
func (s *PayloadScraper) stringToArrayProcessor(input string) []string {
